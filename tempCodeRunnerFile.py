...
class VaultGUI(tk.Tk):
    def __init__(self):
        ...
        # Main container with animation support
    ...
    def setup_theme(self):
        ...
        # Custom entry style
        self.style.configure("Custom.TEntry", fieldbackground="#2c2c2c", 
        ...
        self.style.configure("Status.TLabel", background="#1e1e1e", 
                           foreground="#03dac6", font=("Segoe UI", 9))
        
        # Treeview style for file listings
        self.style.configure("Treeview", background="#1e1e1e", 
                           fieldbackground="#1e1e1e", foreground="white",
                           rowheight=25)
        self.style.map("Treeview", background=[("selected", "#6200ee")])
        self.style.configure("Treeview.Heading", background="#1e1e1e", 
    ...
    def update_status(self, message, error=False):
        ...
        self.status_bar.configure(foreground="#ff4444" if error else "#03dac6")
        if error:
...
class LoadingFrame(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        self.canvas = tk.Canvas(container, width=60, height=60, bg="#121212", 
...
class LoginFrame(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        ttk.Label(container, text="🔒 LOCKNTRUST", font=logo_font, 
                 foreground="#bb86fc").pack(pady=(0, 30))
    ...
    def get_recent_vaults(self):
        ...
        return vaults[:5]  # Return up to 5 most recent
    ...
    def create_vault(self):
        ...
        try:
            ...
            # Simulate long-running operation in thread
    ...
    def _create_vault_thread(self, vault_path, password):
        try:
            # Replace with your actual vault creation code
            time.sleep(2)  # Simulate work
            # self.controller.vault.create_vault(vault_path, password)
    ...
    def _open_vault_thread(self, vault_path, password):
        try:
            # Replace with your actual vault opening code
            time.sleep(2)  # Simulate work
            # self.controller.vault.unlock_vault(vault_path, password)
...
class VaultFrame(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        ttk.Label(header, text="🔓 Vault Contents", 
                 ...
                 foreground="#bb86fc").pack(side="left", padx=20)
        ...
        # File display area - Treeview instead of Text widget
    ...
    def lock_vault(self):
        if messagebox.askyesno("Lock Vault", "Are you sure you want to lock the vault?"):
            # Replace with actual vault locking code
            # self.controller.vault.lock_vault()
            self.controller.show_frame("LoginFrame")

    def refresh_file_list(self):
        self.tree.delete(*self.tree.get_children())
        
        # Simulate getting files from vault
        files = [
